...
//        [[NSUserDefaults standardUserDefaults] synchronize];
        ...
        for (NSDictionary *note in notes) {
            Note *noteManagedObj = [NSEntityDescription insertNewObjectForEntityForName:@"Note" inManagedObjectContext:self.managedObjectContext];
...
- (NSArray *)fetchNotes
{
    ...
    notes = [self.managedObjectContext executeFetchRequest:noteFetch error:&fetchError];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.ccox.PokemonADay" in the application's documents directory.
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"PokemonADay.sqlite"];
    NSError *error = nil;
    ...
    if (![_persistentStoreCoordinator addPersistentStoreWithType:NSSQLiteStoreType configuration:nil URL:storeURL options:nil error:&error])
    {
        ...
        // abort() causes the application to geerate a crash log and terminate. You should not use this function in a shipping application, although it may be useful during development.
